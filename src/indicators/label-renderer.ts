export type IndicatorLabelTemplate = Record<string, string>;

export interface IndicatorLabelRenderOptions {
  themeKey: string;
  template?: IndicatorLabelTemplate;
}

export interface IndicatorLabelRenderer {
  render(options: IndicatorLabelRenderOptions): string;
}

const defaultIndicatorLabelHtml = /* html */ `
...
export const indicatorLabelTemplate: IndicatorLabelTemplate = {
  light: defaultIndicatorLabelHtml,
  dark: defaultIndicatorLabelHtml
};

export class TemplateIndicatorLabelRenderer implements IndicatorLabelRenderer {
  constructor(private readonly fallbackTemplate = indicatorLabelTemplate) {}

  render({ themeKey, template }: IndicatorLabelRenderOptions) {
    const templates = template ?? this.fallbackTemplate;
    return (
      templates[themeKey] ??
      templates.light ??
      templates.default ??
...
export const defaultIndicatorLabelRenderer =
  new TemplateIndicatorLabelRenderer();
